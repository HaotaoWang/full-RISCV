...
// ============================================================================
// FPGA 专用 SoC 顶层 (使用 axi_ram_init 替代 axi_ram)
// ============================================================================
...
module RV32_SoC_AXI_Top_FPGA #(
    ...
    RV32I46F5SPMMIO cpu_core (
        ...
        .m_axi_mem_awid(cpu_mem_awid),       .m_axi_mem_awlen(cpu_mem_awlen),
        .m_axi_mem_awburst(cpu_mem_awburst), .m_axi_mem_awprot(cpu_mem_awprot),
        ...
        .m_axi_mem_arid(cpu_mem_arid),       .m_axi_mem_arlen(cpu_mem_arlen),
        .m_axi_mem_arburst(cpu_mem_arburst), .m_axi_mem_arprot(cpu_mem_arprot),
