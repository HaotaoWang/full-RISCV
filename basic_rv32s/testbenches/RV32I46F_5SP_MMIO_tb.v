...
module RV32I46F5SPMMIO_tb;
    ...
    initial begin
        ...
        $display("Register x1 = %d", rv32i46f_5sp_mmio.register_file.registers[1]);
        $display("Register x2 = %d", rv32i46f_5sp_mmio.register_file.registers[2]);
        $display("Register x3 = %d (Expected: 120 / 0x78)", rv32i46f_5sp_mmio.register_file.registers[3]);
